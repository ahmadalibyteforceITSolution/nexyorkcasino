...
const places = [
  {
    ...
    desc: "A breathtaking observation experience where the city skyline meets high-fashion luxury."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    desc: "Experience the vibrant, high-energy nightlife of Times Square from a VIP perspective."
  }
];
</script>
